...
class StartCommand extends CommandBase {
  ...
  FutureOr run() async {
    ...
    switch (resultStateManagement) {
      ...
      case 2:
        //Instal flutter_bloc
        result = await Slidy.instance.instalation.install(package: PackageName('flutter_bloc@8.0.1', isDev: false));
        execute(result);
        //Instal bloc_test
        result = await Slidy.instance.instalation.install(package: PackageName('bloc_test@9.0.3', isDev: true));
        execute(result);
        //Create a cubit
